...
/////
// extern function pointers for the dynamic rendering -- Alex

#ifndef _DLL_BUILD

extern void (*GL_SelectTexture )(GLenum target, qboolean bl_mtexable, 
                       lpSelTexFUNC qglSelectTextureSGIS, int currenttexture,
                       int * cnttextures);

extern void (*R_DrawSpriteModel )(entity_t *e, entity_t *currententity,
                        double cltime, vec3_t vup, vec3_t vright);
extern void (*GL_DrawAliasFrame )(aliashdr_t *paliashdr, int posenum, 
                        float * shadedots, float shadelight,entity_t  *currententity );
//extern void (*GL_DrawAliasFrame )(aliashdr_t *paliashdr, int posenum, 
//                       float * shadedots, float shadelight);


extern void (*GL_DrawAliasShadow )(aliashdr_t *paliashdr, entity_t * currententity,
                         int posenum, vec3_t shadevector,
                         vec3_t lightspot);

extern void (*R_PolyBlend )(float * v_blend, cvar_t * gl_polyblend);
extern void (*R_DrawSequentialPoly )(msurface_t *s, int lightmap_textures,
...
extern void (*DrawGLWaterPoly )(glpoly_t *p, double realtime);
extern void (*DrawGLWaterPolyLightmap )(glpoly_t *p, double realtime);
extern void (*DrawGLPoly )(glpoly_t *p);
extern void (*R_BlendLightmaps )( glpoly_t ** lightmap_polys, int lightmap_textures,
                       ...
                       double realtime );
extern void (*R_DrawParticles )(particle_t ** active_particles, particle_t ** free_particles,
...
extern void (*EmitWaterPolys )(msurface_t *fa, double realtime);
extern void (*EmitSkyPolys )(msurface_t *fa, float speedscale, vec3_t r_origin);
